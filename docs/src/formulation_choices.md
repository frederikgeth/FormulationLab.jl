...
These are three mathematical families, with explicit strengthening and numerical
options, rather than a new formulation name for every benchmark switch. In
