...
| `BranchFlowSDP` | Experimental radial prototype added after this decision baseline. | Exposes local bus/edge moments and a classic series-line branch-flow SDP; its initial component subset is deliberately narrower than IVRSDP. |
