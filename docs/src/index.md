...
[IVRSDP](sdp.md) is a dense current–voltage semidefinite relaxation with explicit
winding connections, fixed-tap transformers, and regulators. Neither result is
an AC feasibility certificate. Read the [coverage contract](coverage.md) before
