...
@testset "LinDist3Flow canonical lowering: switches" begin
    ...
    prepared = FormulationLab._l3f_prepare(switched;
...
@testset "LinDist3Flow canonical lowering: line shunts" begin
    ...
    prepared = FormulationLab._l3f_prepare(shunted;
        options=L3FOptions(validate_nonlinear=false, unsupported=:lower))
    ...
    full_findings = FormulationLab.L3FFinding[]
    FormulationLab._l3f_lower_line_shunts!(full_findings, full)
    ...
    triangular_findings = FormulationLab.L3FFinding[]
    FormulationLab._l3f_lower_line_shunts!(triangular_findings, triangular)
