...
@testset "LinDist3Flow Yd/Dy orientation gate" begin
    for subtype in ("delta_wye", "wye_delta")
        ...
        D = FormulationLab._l3f_connection_incidence("DELTA", 3, 3)
        g, _ = FormulationLab._l3f_delta_transformer_gain(subtype, data)
        T = FormulationLab._l3f_delta_gauge_map(D, g)
